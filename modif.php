			  ...
			  <form method="post" action="./view/evaluate_food_check.php">
			    <table class="note-edit-table">
			      ...
			      <tr>
			        <td colspan="2">
			          <p>我的评论：</p>
			          <textarea class="note-edit-content" name="content" placeholder="更新评论"></textarea>
			        </td>
			      </tr>
			      <tr>
			        <td>
			        ...
			        <td>
			          <input class="note-edit-submit" type="submit" value="提交" onclick="">
